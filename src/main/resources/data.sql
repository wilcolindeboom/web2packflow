...
insert into batches (id, closed) VALUES (0,false);

insert into orderitems (source_order_id, source_item_id, batch_id) values ('order1', 'item1', 0);
insert into orderitems (source_order_id, source_item_id, batch_id) values ('order2', 'item2', 0);
insert into orderitems (source_order_id, source_item_id, batch_id) values ('order3', 'item3', 0);
insert into orderitems (source_order_id, source_item_id, batch_id) values ('order4', 'item4', 0);
insert into orderitems (source_order_id, source_item_id, batch_id) values ('order5', 'item1', 0);
