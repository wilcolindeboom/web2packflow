...
--
insert into batches (id, open, substrate_id, finish_name, product_group_id) VALUES (0,true,'000269','IVO43', 21 );

insert into orderitems (source_item_id, finish_name, substrate_id, source_order_id, batch_id, product_group_id) VALUES ('item1', 'IVO43','000269','order1',0,'21');
insert into orderitems (source_item_id, finish_name, substrate_id, source_order_id, batch_id, product_group_id) VALUES ('item2', 'IVO43','000269','order2',0,'21');
insert into orderitems (source_item_id, finish_name, substrate_id, source_order_id, batch_id, product_group_id) VALUES ('item3', 'IVO43','000269','order3',0,'21');
insert into orderitems (source_item_id, finish_name, substrate_id, source_order_id, batch_id, product_group_id) VALUES ('item4', 'IVO43','000269','order4',0,'21');
insert into orderitems (source_item_id, finish_name, substrate_id, source_order_id, batch_id, product_group_id) VALUES ('item1', 'IVO43','000269','order5',0,'21');
